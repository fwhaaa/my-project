  ...
  return (
    <div style={{ padding: "40px 60px" }}>
      ...
      >
        ...
        {single &&
          Object.keys(single).map((v, index) => {
        ...
        {multiple &&
          Object.keys(multiple).map((v, index) => {
            ...
            const label =
              rightAnswerStr === studentAnswerStr ? (
                <span style={{ color: "green" }}>
                  {" "}
                  {`${index + 1}、${multipleObj.stem}`}{" "}
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;回答正确
                </span>
              ) : (
                <span style={{ color: "red" }}>
            ...
            return (
              <FormItem
                disabled
                field={`multiple_${multipleObj.id}`}
                label={label}
                style={{ textAlign: "left" }}
              >
            ...
            const label =
              rightAnswer === studentAnswer ? (
                ...
                <span style={{ color: "red" }}>
                  ...
                  {rightAnswer === "true" ? "正确" : "错误"}
                </span>
              );
            return (
              <FormItem
                disabled
                field={`judge_${judgeObj.id}`}
                label={label}
                style={{ textAlign: "left" }}
              >
                <RadioGroup direction="vertical">
        ...
        {saq &&
          Object.keys(saq).map((v, index) => {
            ...
            return (
              ...
              // </FormItem>
              <Form.Item
                field={`saq_${saqObj.id}`}
                label={`${index + 1}、${saqObj.stem}`}
                style={{ textAlign: "left" }}
                disabled
              >
                <Grid.Row gutter={8}>
